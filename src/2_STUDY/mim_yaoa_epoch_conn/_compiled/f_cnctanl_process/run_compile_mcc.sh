...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_STUDY/mim_yaoa_epoch_conn/_slurm_logs/%j_a_epoch_process_compile.log # Standard output

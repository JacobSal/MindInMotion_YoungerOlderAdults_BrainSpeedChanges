...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_STUDY/mim_yaoa_slide_conn/_slurm_logs/%j_ff_cnctanl_trial_comps.log # Standard output
...
# Kick off matlab
matlab -nodisplay < $STUDY_DIR/ff_cnctanl_trial_comps.m

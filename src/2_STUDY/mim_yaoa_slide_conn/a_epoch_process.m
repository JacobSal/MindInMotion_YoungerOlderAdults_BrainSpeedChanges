%   Project Title: MIM YOUNGER AND OLDER ADULTS SLIDE_CONNECTIVITY
%
%   Code Designer: Jacob salminen
%## SBATCH (SLURM KICKOFF SCRIPT)
% sbatch /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_STUDY/mim_yaoa_slide_conn/run_a_epoch_process.sh
...
%- datetime override
dt = '04112023_MIM_YAOAN89_antsnormalize_iccREMG0p4_powpow0p3_skull0p01_slide_conn';
...
try
    ...
    [MAIN_ALLEEG] = mim_create_alleeg(fNames,fPaths,subjectNames,save_dir,...
                        conditions,groups,sessions,'DO_SAVE_ICA',true);

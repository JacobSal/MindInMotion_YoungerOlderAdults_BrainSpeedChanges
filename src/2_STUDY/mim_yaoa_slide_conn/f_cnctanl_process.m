...
%- (06/18/2024) {'Group Lasso (DAL/SCSA)'} Takes a long long time. Ran for
%24hrs and no models were fit ?sufficiently?. Need to take a deeper look at
%this fitting method. This may be due to the fact that this method assumes
%sensor space and not source space (ICA'd EEG data). see. https://ieeexplore.ieee.org/document/5466024
%- 
%##

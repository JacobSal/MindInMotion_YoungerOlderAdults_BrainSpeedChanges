...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_STUDY/mim_yaoa_terrain_clin/_slurm_logs/%j_c_fooof_spec_data.log # Standard output
#SBATCH --account=dferris # Account name
#SBATCH --qos=dferris-b # Quality of service name
#SBATCH --partition=hpg-default # cluster to run on, use slurm command 'sinfo -s'
# sbatch /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_STUDY/mim_yaoa_terrain_clin/run_c_fooof_spec_data.sh
...
# Kick off matlab
matlab -nodisplay < $STUDY_DIR/c_fooof_spec_data.m

...
%                 ersp_pgroup = {erspDiff.pgroup};
    ...
    %             PLOT_STRUCT_PAR.figure_title = sprintf('%s based',data_chars{data_i});
                ...
                exportgraphics(fig,[save_dir filesep sprintf('cl%i_des%i_group%s_spcadiff_%s.tiff',cl_i,des_i,groups{groups_ind(group_i)},data_chars{data_i})],'Resolution',SAVE_RESOLUTION);

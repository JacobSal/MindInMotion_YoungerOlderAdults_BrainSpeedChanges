...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_STUDY/mim_yaoa_speed_kin/_slurm_logs/%j_c_fooof_spec_data.log # Standard output
...
# Kick off matlab
matlab -nodisplay < $SCRIPT_DIR/c_fooof_spec_data.m

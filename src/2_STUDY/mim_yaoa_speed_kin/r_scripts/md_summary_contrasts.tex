...
\urlstyle{same}
\hypersetup{
  pdftitle={md\_summary\_contrasts},
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{clusters }\OtherTok{=} \FunctionTok{unique}\NormalTok{(table\_out}\SpecialCharTok{$}\NormalTok{cluster\_id);}
\NormalTok{subjects }\OtherTok{=} \FunctionTok{unique}\NormalTok{(table\_out}\SpecialCharTok{$}\NormalTok{subj\_char);}
\NormalTok{eeg\_measures }\OtherTok{=} \FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}alpha\_avg\_power\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}beta\_avg\_power\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}theta\_avg\_power\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}aperiodic\_exp\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}aperiodic\_offset\textquotesingle{}}\NormalTok{);}
\end{Highlighting}
\end{Shaded}

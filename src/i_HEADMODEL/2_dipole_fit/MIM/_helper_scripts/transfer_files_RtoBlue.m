...
run_dir = [source_dir filesep '1_BATCH_PREP' filesep 'alpha' filesep 'MIM' filesep '_helper_scripts'];
...
%% ===================================================================== %%
%% (HELPER SCRIPT) REMOVE HEADMODEL DIRECTORY
...
%             fprintf('copying file %s.\n',tmp);
        ...
        tmp = [R_MIND_IN_MOTION_DIR filesep SUBJ_PICS{group_i}{subj_i} filesep 'MRI' filesep 'Segmentation' filesep 'headreco' filesep sprintf('m2m_%s',SUBJ_PICS{group_i}{subj_i}) filesep sprintf('%s_masks_contr.nii.gz',SUBJ_PICS{group_i}{subj_i})];
        if exist(tmp,'file')
%             fprintf('copying file %s.\n',tmp);
            copyfile(tmp,folder_to);
        else

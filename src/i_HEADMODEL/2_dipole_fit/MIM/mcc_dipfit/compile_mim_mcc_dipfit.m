...
%- run exe_2ndf
% sbatch /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/i_HEADMODEL/2_dipole_fit/MIM/mcc_dipfit/run_mim_mcc_dipfit_exe_2nd.sh
%
%{
%## RESTORE MATLAB
...
files_to_compile={'/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/i_HEADMODEL/2_dipole_fit/MIM/mcc_dipfit/mim_mcc_dipfit.m',...
    ...
    '/blue/dferris/jsalminen/GitHub/par_EEGProcessing/submodules/fieldtrip/ft_prepare_headmodel.m',...
    };
fprintf('Compiling...\n');
...
mcc('-m',files_to_compile{:},'-d',out_dir,'-v','-a','/blue/dferris/jsalminen/GitHub/par_EEGProcessing/submodules/fieldtrip/external/simbio/calc_stiff_matrix_val.mexa64')
%## TOC
toc
exit();
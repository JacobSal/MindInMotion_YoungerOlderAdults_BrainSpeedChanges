...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/i_HEADMODEL/py_ants_norm/%j_ants_norm.log # Standard output
#SBATCH --account=dferris # Account name
#SBATCH --qos=dferris-b # Quality of service name
#SBATCH --partition=hpg-default # cluster to run on, use slurm command 'sinfo -s'
#%% sbatch /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/i_HEADMODEL/py_ants_norm/ants_norm.bash
cd /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/i_HEADMODEL/py_ants_norm/
ml gcc/5.2.0
ml ants
...
# export SUBJ_EEG="/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/_data/MIM_dataset/_studies/10302023_OAN82_iccRX0p60_iccREMG0p4_newparams"
...
export dip_csv_out=$SUBJ_EEG/$s/head_model/dip_pos_out.csv

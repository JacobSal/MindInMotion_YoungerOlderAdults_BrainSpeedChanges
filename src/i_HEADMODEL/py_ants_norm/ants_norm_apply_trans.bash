...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/i_HEADMODEL/py_ants_norm/%j_ants_norm_trans.log # Standard output
#SBATCH --account=dferris # Account name
#SBATCH --qos=dferris-b # Quality of service name
#SBATCH --partition=hpg-default # cluster to run on, use slurm command 'sinfo -s'
#%% sbatch /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/i_HEADMODEL/py_ants_norm/ants_norm_apply_trans.bash
...
do
	...
	export dip_csv_outi="$SUBJ_EEG/$s/head_model/dip_pos_outi.csv"

function [SUBJ] = subj_i_epoch(PATHS,SUBJ,processNum,studyName,parseVar,...
                            trialType,epochTimeLimits,varargin)
...
%## SET DEFAULTS
parse(p,PATHS,SUBJ,processNum,studyName,parseVar,trialType,epochTimeLimits,varargin{:})
...
chk = regexp(trialType,'\d');
if any(chk)
    trialType = sprintf('x%s',trialType);
end

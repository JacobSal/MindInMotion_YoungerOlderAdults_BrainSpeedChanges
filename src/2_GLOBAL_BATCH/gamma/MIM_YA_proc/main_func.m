...
%         TMP_EEG = pop_epoch(EEG,{EVENT_CHAR},EPOCH_TIME_LIMITS,'eventindices',valid_points(1):valid_points(2),'epochinfo','yes');
        ...
        TMP_EEG = pop_epoch( EEG, {  'RHS'  }, EPOCH_TIME_LIMITS, 'eventindices',valid_points(1):valid_points(2), 'newname', sprintf('Merged datasets %s epochs',EEG.subject), 'epochinfo', 'yes');

...
% sbatch /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_GLOBAL_BATCH/MIM_OA/run_a_epoch_process.sh
...
SUBJ_DEBUG = {'H2117','NH3082','H3063','NH3006','NH3025','NH3114','H2007',...
    ...
    'NH3056','NH3036','H3046','H3053','NH3007','H3077','H3047','NH3071','NH3129'};
%- (OY) Subject Picks 
% SUBJ_PICS = {SUBJ_1YA}; 
% GROUP_NAMES = {'H1000''s'}; 

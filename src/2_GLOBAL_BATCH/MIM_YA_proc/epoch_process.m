...
% sbatch /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_GLOBAL_BATCH/MIM_YA_proc/run_epoch_process.sh
...
%- Subject Picks
SUBJ_PICS = {SUBJ_1YA};
SUBJ_ITERS = {1:length(SUBJ_1YA)}; % CHANG,LIU(12/26/2023)
GROUP_NAMES = {'H1000s'};
%% (PARAMETERS) ======================================================== %%
%## hard define
%- datset name

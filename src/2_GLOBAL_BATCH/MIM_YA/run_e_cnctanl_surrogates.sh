...
#SBATCH --output=./_hpg_logs/%j_MIM_YA_d_cnctanl_process.log # Standard output
...
# Kick off matlab
matlab -nodisplay < /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_GLOBAL_BATCH/MIM_YA/d_cnctanl_process.m

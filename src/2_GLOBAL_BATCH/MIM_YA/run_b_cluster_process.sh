#!/bin/bash
#SBATCH --job-name=MIM_YA_CLUSTER # Job name
...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_GLOBAL_BATCH/MIM_YA/_hpg_logs/%j_MIM_YA_b_cluster_process.log # Standard output
...
# Kick off matlab
matlab -nodisplay < /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_GLOBAL_BATCH/MIM_YA/b_cluster_process.m

...
%- run .sh
% sbatch /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/3_ANALYZE/MIM_YA/run_c_ersp_gen_expanded.sh
...
STAT_PARAMS = struct('condstats','on',... % ['on'|'off]
    ...
    'fieldtripmethod','fdr',... %[('montecarlo'/'permutation')|'parametric']

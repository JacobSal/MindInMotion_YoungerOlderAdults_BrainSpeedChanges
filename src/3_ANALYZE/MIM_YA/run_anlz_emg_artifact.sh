#!/bin/bash
#SBATCH --job-name=ANLZ_EMG # Job name
...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/3_ANALYZE/MIM_OA/_hpg_logs/%j_anlz_emg_artifact.log # Standard output
...
# Kick off matlab
matlab -nodisplay < /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/3_ANALYZE/MIM_OA/anlz_emg_artifact.m

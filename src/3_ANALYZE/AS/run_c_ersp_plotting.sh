...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/3_ANALYZE/AS/_hpg_logs/%j_c_ersp_plotting.log # Standard output
...
# Kick off matlab
matlab -nodisplay < /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/3_ANALYZE/AS/c_ersp_plotting.m

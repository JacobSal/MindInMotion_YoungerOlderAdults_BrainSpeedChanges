...
% tmp = load('-mat','M:\jsalminen\GitHub\par_EEGProcessing\src\_data\MIM_dataset\_studies\10052023_MIM_OAN70_noslowwalkers_gait\cluster\icrej_5\12\spec_data\temp_study_rejics5.study');
% STUDY = tmp.STUDY;
[STUDY,ALLEEG] = pop_loadstudy('M:\jsalminen\GitHub\par_EEGProcessing\src\_data\MIM_dataset\_studies\10052023_MIM_OAN70_noslowwalkers_gait\cluster\icrej_5\12\spec_data\temp_study_rejics5.study');
save_dir = 'M:\jsalminen\GitHub\par_EEGProcessing\src\_data\MIM_dataset\_studies\10052023_MIM_OAN70_noslowwalkers_gait\cluster\icrej_5\12\figure_plots';
if ~exist(save_dir,'dir')
    mkdir(save_dir)
end
%- get inds

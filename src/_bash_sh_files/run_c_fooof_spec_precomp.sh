...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/MIND_IN_MOTION_PRJ/MindInMotion_YoungerOlderAdult_BrainSpeedChanges/src/_slurm_logs/%j_c_fooof_spec_precomp.log # Standard output
